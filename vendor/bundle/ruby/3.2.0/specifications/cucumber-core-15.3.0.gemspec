...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<cucumber-gherkin>.freeze, ["> 27", "< 35"])
  s.add_runtime_dependency(%q<cucumber-messages>.freeze, ["> 26", "< 30"])
  s.add_runtime_dependency(%q<cucumber-tag-expressions>.freeze, ["> 5", "< 9"])
  s.add_development_dependency(%q<rake>.freeze, ["~> 13.3"])
  s.add_development_dependency(%q<rspec>.freeze, ["~> 3.13"])
  s.add_development_dependency(%q<rubocop>.freeze, ["~> 1.80.0"])
  s.add_development_dependency(%q<rubocop-packaging>.freeze, ["~> 0.6.0"])
  s.add_development_dependency(%q<rubocop-rake>.freeze, ["~> 0.7.0"])
